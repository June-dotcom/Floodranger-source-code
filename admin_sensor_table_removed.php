          ...
          <div class="page-titles">
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="admin_sensor_table_view.php?sensor_id=<?php echo  $_GET['sensor_id']; ?>"> Recent logs for <?php echo $_GET['sensor_id']; ?></a></li>
                    <li class="breadcrumb-item"><a href="#">Removed logs archived for <?php echo $_GET['sensor_id']; ?></a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
         <?php include 'admin_sensor_table_rem_sub.php'; ?>
     </div>
