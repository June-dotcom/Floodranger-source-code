<?php 
include "dbconn.php";
// must return sensor_value timestamps
// $sensor_id = $_GET['sensor_id'];

// this day hourly result
// this week daily result
// this month daily avg result
// this year daily monthly avg result
...
// start of this day
 // URDULTRSNR01
$sql_tmp_fd_hr = "SELECT DISTINCT HOUR(sensor_log_tmp.timestamps) as hours, DATE(sensor_log_tmp.timestamps) as date_tmp  FROM (SELECT * FROM sensor_logs WHERE sensor_id = '$sensor_id') AS sensor_log_tmp WHERE DATE(sensor_log_tmp.timestamps) = CURDATE() - 1;";
