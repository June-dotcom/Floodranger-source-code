    <div class="col col-12">
                          ...
                          <div class="modal-header">
                            <form action="submit_new_number.php" id="form_add_new_contact" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input required class="form-control" name="phone_number" id="add_phone_number"></input>
                                    <label>Address</label>
                                    <select name="address_id" form="form_add_new_contact" id="add_address" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                                        <?php
     ...
     <div class="card-body">
        <div class="table-responsive">
                ...
                <tbody>
                   ...
                   foreach($posts as $post){
                    ...
                    <td>
                      ...
                      data-toggle="modal" data-target="#deleteModal<?php echo $post->contacts_id?>">Delete</button>

                      <button type="button" class="btn btn-info btn-round btn-sm"
                      data-toggle="modal" data-target="#editModal<?php echo $post->contacts_id?>">Edit</button>
                      
                  </td>

                  <!-- Modal -->
                  <div class="modal fade" id="deleteModal<?php echo $post->contacts_id?>" tabindex="-1" aria-labelledby="deleteModal<?php echo $post->contacts_id?>Label" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-body">
                            <h4 class="text-center lead">Do you want to delete this contact named <?php echo $post->contact_name?> ?</h4>
                        </div>
                        <div class="modal-footer">
                           <a class="btn btn-danger btn-round btn-sm" href="delete_contact_num.php?id=<?php echo $post->contacts_id?>">Yes</a>
           ...
           <!-- modal start -->
           <div class="modal fade" id="editModal<?php echo $post->contacts_id?>" tabindex="-1" aria-labelledby="editModal<?php echo $post->contacts_id?>" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="submit_edit_contacts.php" id="form_edit_contact<?php echo $post->contacts_id;?>" method="POST">
                      <div class="modal-header">

                        <h5 class="modal-title " id="editModal<?php echo $post->contacts_id?>">Edit contact number</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </div>
                        <div class="modal-body">
                            <label>Name</label>
                            <input class="form-control" name="contact_name" value="<?php echo $post->contact_name ? $post->contact_name: ''; ?>"></input>
                            <label>Email</label>
                            <input class="form-control" name="email" id="email_id<?php echo $post->contacts_id; ?>" value="<?php echo $post->email ? $post->email: ''; ?>"></input>                    
                            <label>Phone number</label>
                            <input class="form-control" name="phone_number" value="<?php echo $post->phone_number ? $post->phone_number: ''; ?>"></input>
                            <label>Address</label>
                            <br/>
                            <input type="hidden" name="contact_id" value="<?php echo $post->contacts_id;?>">
                            <div id='result'></div>
                            <select name="address_id" form="form_edit_contact<?php echo $post->contacts_id?>" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                    ...
                    <div class="modal-footer">
                     <button type="button" class="btn btn-secondary"
                     data-dismiss="modal">Close</button>
                     <button class="btn btn-primary" onclick="validateEditId('email_id<?php echo $post->contacts_id; ?>', 'form_edit_contact<?php echo $post->contacts_id;?>', 'reg_status_fields_id<?php echo $post->contacts_id?>')">Save changes</button>

                     <input hidden type="submit" class="btn btn-primary" form="form_edit_contact<?php echo $post->contacts_id?>" value="Save changes" name="">
                 </div>
             </div>
         </div>
         <!-- modal end -->
