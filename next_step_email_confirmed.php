...
$get_email_token_qry = $pdo->query("SELECT * FROM `email_verify_token` WHERE `auth_token_id` = '$email_token'");
...
$email_tmp = $get_user_obj->email;
$sql_query_upd_permitted = "UPDATE `contacts` SET `is_permitted` = '1' WHERE `email` = '$email_tmp'";
$pdo->exec($sql_query_upd_permitted);
		...
		<div class="col-12  col-xl-8 col-lg-9 col-md-10 mt-5">
			<div class="card">
				...
				if ($is_email_token_valid == "yes") {
					...
					?>
<div class="card-body">
						<h1>Invalid email verification link</h1>
