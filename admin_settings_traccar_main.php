                ...
                <div class="page-titles">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Traccar SMS gateway</li>
                        </ol>
                    </nav>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-4">
                        <a href="admin_settings_traccar_gateway.php">
                            <div class="card">
                                <div class="card-body">
                                    Edit traccar SMS api key
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-12 col-lg-4">
                            <a href="admin_settings_traccar_sms.php">
                                <div class="card">
                                    <div class="card-body">
                                        Send Test messages
                                    </div>
